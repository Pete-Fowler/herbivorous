  ...
  return loaded === "API" ? (
    <div id="details">
      <div id="text">
        ...
        <h2>Ingredients</h2>
        <ul id="ingredients">
          {details.extendedIngredients.map((obj) => (
        ...
        <p>
          <a href={details.spoonacularSourceUrl}>
            Link to recipe source on spoonacular.com
          </a>
        </p>
      </div>
    </div>
    ...
    <div id="details">
      <div id="text">
        ...
        <h3>Ingredients</h3>
        <p id="ingredients">{details.ingredients}</p>
        <h3>Instructions</h3>
        <div id="instructions">{details.instructions}</div>
        <p>
          <a href={details.link}>Link to recipe source</a>
        </p>
      </div>
    </div>
  ) : (
